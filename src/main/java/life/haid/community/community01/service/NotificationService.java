...
import life.haid.community.community01.mapper.NotificationMapper;
...
public class NotificationService {
    ...
    public Long unreadCount(Long userId) {
        NotificationExample notificationExample = new NotificationExample();
        notificationExample.createCriteria().andReceiverEqualTo(userId).andStatusEqualTo(NotoficationStatusEnum.UNREAD.getStatus());
    ...
    public NotificationDTO read(Long id, User user) {
        ...
        notification.setStatus(NotoficationStatusEnum.READ.getStatus());
